...
final def BASE_DIR=BUILD_BASE_DIR + "/atlassian-jgitflow-plugin";
...
GitRepository.recreateAt("${LOKALES_REPO}").setup {
	...
	copyExternalDirectory '/Users/nils/develop/wjax2014_git_workshop/git-repos/maventest/gitdsl/wjax-repositories/web-application-gitflow'
